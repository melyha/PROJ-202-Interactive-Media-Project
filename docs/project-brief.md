...
### 🎨 Visual Direction
Pixel art. Retro colour palette.

### 💡 Mood & Tone
Mysterious and slightly eerie — the player character is an unnamed figure in an unknown world. Environmental storytelling.The world feels like something ancient and forgotten.
...
- [GitHub Pages Deployment with Vite](https://vitejs.dev/guide/static-deploy.html#github-pages)
